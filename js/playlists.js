...
class classMountain {
    ...
    balao(){
        ...
        text("Loudness: " + map(this.py, 0.3, 1, 0, 100).toFixed(1) + "%", this.px + 10, this.py - 130 + (this.valor*7.7));
        text("Speed: " + map(this.px, 13, 20, 0, 1.0).toFixed(1)*100 + "%", this.px + 10, this.py - 110 + (this.valor*7.7));
