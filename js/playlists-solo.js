...
class classMountain {
    ...
    balao(){
        ...
        textStyle(NORMAL);
        text("Energy: " + map(this.round, 30,0, 0, 100).toFixed(1) + "%", this.px + 10, this.py - 190 + (this.valor*6.2));
        text("Danceability: " + map(this.tChange, 0.01, 0.06, 0, 100).toFixed(1) + "%", this.px + 10, this.py - 170 + (this.valor*6.2));
        text("Positivity: " + map(this.color, 190,0, 0, 100).toFixed(1) + "%", this.px + 10, this.py - 150 + (this.valor*6.2));
        text("Loudness: " + map(this.py, height,0, 0, 100).toFixed(1) + "%", this.px + 10, this.py - 130 + (this.valor*6.2));
        text("Speed: " + map(this.px, 0, width, 0, 100).toFixed(1) + "%", this.px + 10, this.py - 110 + (this.valor*6.2));
        text("Total songs: " + this.numtracks, this.px + 10, this.py - 90 + (this.valor*6.2));
